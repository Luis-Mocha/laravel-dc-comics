    ...
    <div id="comics-main" class="container">
        ...
        <form action=" {{ route('comics.store') }} " method="POST" class="row" autocomplete="off">
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" id="input-title" class="form-control" name="title" placeholder="Inserisci il titolo" autofocus required> 
            </div>
            ...
            <div class="form-group mt-3 col-6">
                ...
                <input type="text" id="input-series" class="form-control" name="series" placeholder="Inserisci la serie di appartenenza" required> 
            </div>
